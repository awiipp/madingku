...
@section('body')
    ...
    <div class="flex font-quicksand">
        ...
        <div class="flex-1 md:px-28 px-10 md:pt-36 pt-24 mb-36">
            ...
            <h1 class="font-bold text-4xl mb-3">Job & Education Fair: Optimis Perjuangan - SMKN 46 Jakarta</h1>
            <div class="flex justify-between font-semibold mb-8">
                <p>Oleh Kang Hyewon | Event</p>
                <p>11 Des 2023</p>
            </div>
            <img src="{{ asset('thumbnails/jobfair.jpg') }}" alt="" class="rounded-lg w-full mb-5">
